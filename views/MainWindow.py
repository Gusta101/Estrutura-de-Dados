...
from PageModels import InserirManager
from PageModels import AlterarManager
from PageModels import BuscarManager
...
class MainWindow(QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        self.btn_inserir_f.clicked.connect(lambda: self.inserir_manager.inserir(0))
        self.btn_p_inserir.clicked.connect(lambda: self.inserir_manager.inserir(1))
